...
<div className="mt-3 rounded-md border border-emerald-200/80 bg-emerald-50 px-3 py-2 text-sm text-emerald-900 dark:border-emerald-300/50 dark:bg-emerald-400/10 dark:text-emerald-100" role="note">
  <p className="leading-6">用語メモ: <Strong>リポジトリ</Strong> は Git が履歴を保管するための金庫付きフォルダです。中にある <Code>.git</Code> が、過去の記録や設定をまとめて管理しています。</p>
</div>
...
<div className="mt-3 rounded-md border border-emerald-200/80 bg-emerald-50 px-3 py-2 text-sm text-emerald-900 dark:border-emerald-300/50 dark:bg-emerald-400/10 dark:text-emerald-100" role="note">
  <p className="leading-6">用語メモ: <Strong>Untracked</Strong> は「まだ見張っていない」という意味です。<Code>git add</Code> でステージに入れると、Git がそのファイルを監視し始めます。</p>
</div>
<div className="mt-3 rounded-md border border-emerald-200/80 bg-emerald-50 px-3 py-2 text-sm text-emerald-900 dark:border-emerald-300/50 dark:bg-emerald-400/10 dark:text-emerald-100" role="note">
...
<div className="mt-3 rounded-md border border-emerald-200/80 bg-emerald-50 px-3 py-2 text-sm text-emerald-900 dark:border-emerald-300/50 dark:bg-emerald-400/10 dark:text-emerald-100" role="note">
  <p className="leading-6">用語メモ: <Strong>コミット</Strong> はその瞬間のスナップショットを保存する操作です。オプションの <Code>--oneline</Code> はログを 1 行表示にまとめ、進捗をざっと確認したいときに便利です。</p>
</div>
